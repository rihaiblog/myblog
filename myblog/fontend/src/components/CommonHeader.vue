...
<div>
  ...
  <header>
      <div class="wrapper">
        <el-row>
          <el-col :span="4">
            <div class="logo threed">陈室长个人博客</div>
          </el-col>
          <el-col :span="20">
            <!-- 导航菜单 -->
            ...
            >
              ...
              <el-menu-item index="7"  @click="goToto">
                 <router-link to="/article" v-if="isSignIn === 1 && nickname === '陈日海'">我的博客</router-link>
              </el-menu-item>
              <el-menu-item index="8" @click="goToto">
               ...
               <el-menu-item index="9"  @click="goToto">
                 <router-link to="/personal"  v-if="isSignIn === 1 "  class="login">{{UserInfo.nickname === '陈日海' ? '尊敬的管理员：' + UserInfo.nickname : '尊敬的游客：'+ UserInfo.nickname}},欢迎您</router-link>
              </el-menu-item>
            </el-menu>
          </el-col>
        </el-row>
      ...
      <el-menu
          ...
          <el-submenu index="1">
            <template slot="title">
              ...
              <span class="logotit">陈室长个人博客</span>
